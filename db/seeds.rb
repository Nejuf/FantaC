...
cpos = ContestPositions.create(contest_id: 1, position_id: 1)
cpos = ContestPositions.create(contest_id: 1, position_id: 2)
cpos = ContestPositions.create(contest_id: 1, position_id: 3)
cpos = ContestPositions.create(contest_id: 1, position_id: 4)
cpos = ContestPositions.create(contest_id: 2, position_id: 1)
cpos = ContestPositions.create(contest_id: 2, position_id: 4)
cpos = ContestPositions.create(contest_id: 3, position_id: 1)
cpos = ContestPositions.create(contest_id: 3, position_id: 2)
cpos = ContestPositions.create(contest_id: 3, position_id: 3)
# cpos = ContestPositions.create(contest_id: , position_id: )
